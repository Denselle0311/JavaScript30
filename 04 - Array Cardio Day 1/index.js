const inventors = [
  ...
  const bornIn1500 = inventors.filter(e => e.year >= 1500);
  ...
  const lives = inventors.reduce((total,invent) => {
        return total + (invent.passed - invent.year);
        }, 0)
  //console.log(lives)
  ...
  // https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris
    //const de = link.filter(streetName => streetName.includes('de'));
